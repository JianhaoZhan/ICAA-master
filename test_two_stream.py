...
import torch
#import models.finetune.model as att1
import models.final.model as att#models.serial_model.model_zjh as att2
...
def test():
    ...
    model1, parameters1 = att.generate_model(opt)

    # if testing RGB+Flow streams change input channels
    if not opt.only_RGB:
        opt.input_channels = 2 
    model2, parameters2 = att.generate_model(opt)
