...
class sta(nn.Module):
  ...
  def forward(self,sta_input: Tensor)-> Tensor:
    ...
    if self.serial:
        ...
        input_t1 = torch.mean(input_t1,dim=1,keepdim=True)
        ...
        input_t3 = torch.mean(input_t,dim=1,keepdim=True)
        ...
        input_s1 = torch.mean(input_s,dim=1,keepdim=True)
        ...
        input_s3 = torch.mean(input_s3,dim=1,keepdim=True)
