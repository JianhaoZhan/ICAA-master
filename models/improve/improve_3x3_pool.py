...
class sta(nn.Module):
  ...
  def __init__(self,input_shape,r=128):  # r=32 or 256
    ...
    self.conv_2D_t1_2=torch.nn.Conv2d(in_channels=1,out_channels=self.l,kernel_size=(3,self.r), stride=2, padding=1, dilation=1, groups=1, bias=False)
    self.conv_2D_t1_2.weight=Parameter(torch.Tensor(np.divide(np.ones((self.l,1,3,self.r)),3*self.r/1.8)))
    ...
    self.conv_2D_t2_1.weight=Parameter(torch.Tensor(np.divide(np.ones((self.c//self.r,self.c,3,3)),9.0*self.c/1.8)))
    self.conv_2D_t2_2=torch.nn.Conv2d(in_channels=self.c//self.r,out_channels=self.l,kernel_size=(3,3), stride=2, padding=1, dilation=1, groups=1, bias=False)
    self.conv_2D_t2_2.weight=Parameter(torch.Tensor(np.divide(np.ones((self.l,self.c//self.r,3,3)),(self.c//self.r)*9.0/1.8)))
    ...
    self.conv_2D_t3_2=torch.nn.Conv2d(in_channels=1,out_channels=self.l,kernel_size=(3,3), stride=2, padding=1, dilation=1, groups=1, bias=False)
    self.conv_2D_t3_2.weight=Parameter(torch.Tensor(np.divide(np.ones((self.l,1,3,3)),9.0/1.8)))
    ...
    self.conv_2D_s1_1.weight=Parameter(torch.Tensor(np.divide(np.ones((1,self.c,1,1)),self.c*2.0/1.8)))
    self.conv_2D_s1_2=torch.nn.Conv2d(in_channels=1,out_channels=self.h*self.w,kernel_size=(3,3), stride=2, padding=1, dilation=1, groups=1, bias=False)
    self.conv_2D_s1_2.weight=Parameter(torch.Tensor(np.divide(np.ones((self.h*self.w,1,3,3)),9.0/1.8)))
    ...
    self.conv_2D_s2_1.weight=Parameter(torch.Tensor(np.divide(np.ones((self.c//self.r,self.c,3,3)),9.0*self.c/1.8)))
    self.conv_2D_s2_2=torch.nn.Conv2d(in_channels=self.c//self.r,out_channels=self.h*self.w,kernel_size=(3,3), stride=2, padding=1, dilation=1, groups=1, bias=False)
    self.conv_2D_s2_2.weight=Parameter(torch.Tensor(np.divide(np.ones((self.h*self.w,self.c//self.r,3,3)),9.0*(self.c//self.r)/1.8)))
    ...
    self.conv_2D_s3_2=torch.nn.Conv2d(in_channels=1,out_channels=self.h*self.w,kernel_size=(self.r,3), stride=2, padding=1, dilation=1, groups=1, bias=False)
    self.conv_2D_s3_2.weight=Parameter(torch.Tensor(np.divide(np.ones((self.h*self.w,1,self.r,3)),self.r*3.0/1.8)))
    ...
    self.conv_2D_s_all.weight=Parameter(torch.Tensor(np.divide(np.ones((self.h*self.w,self.h*self.w*3,1,1)),self.h*self.w*3.0/1.8)))
    self.avg_pool_t1=torch.nn.AvgPool2d((2,898),stride=1)
    self.avg_pool_1=torch.nn.AvgPool2d((2,8),stride=1)
    self.avg_pool_2=torch.nn.AvgPool2d((898,8),stride=1)
  ...
  def forward(self,sta_input: Tensor)-> Tensor:
    ...
    if self.serial:
        ...
        input_t1 = self.avg_pool_t1(input_t1)
        ...
        input_t2 = self.avg_pool_1(input_t2)
        ...
        input_t3 = self.avg_pool_1(input_t3)
        ...
        input_s1 = self.avg_pool_1(input_s1)
        ...
        input_s2 = self.avg_pool_1(input_s2)
        ...
        input_s3 = self.avg_pool_2(input_s3)
