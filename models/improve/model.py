...
from models.improve import improve_t#improve_3x3_pool#test # resnext_mul_serial
import pdb 
...
def generate_model( opt):
    ...
    if opt.pretrain_path:
        from models.improve.improve_t import get_fine_tuning_parameters
