...
from models.max_model import resnext_org # resnext_att_add resnext_org resnext_att_mul
import pdb
...
def generate_model( opt):
    ...
    if opt.pretrain_path:
        from models.max_model.resnext_org import get_fine_tuning_parameters
