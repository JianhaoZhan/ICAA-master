...
from models.min_model import resnext_zjh # resnext_mul resnext_mul+para 
import pdb
...
def generate_model( opt):
    ...
    if opt.pretrain_path:
        from models.max_model.resnext_zjh import get_fine_tuning_parameters
