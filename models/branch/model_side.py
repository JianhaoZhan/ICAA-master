...
from models.branch import resnext_side#test # resnext_mul_serial
import pdb 
...
def generate_model( opt):
    ...
    if opt.pretrain_path:
        from models.branch.resnext_side import get_fine_tuning_parameters
