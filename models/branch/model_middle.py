...
from models.branch import resnext_middle#test # resnext_mul_serial
import pdb 
...
def generate_model( opt):
    ...
    model = resnext_middle.resnet101(
    ...
    if opt.pretrain_path:
        from models.branch.resnext_middle import get_fine_tuning_parameters
