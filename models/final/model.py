...
from models.final import resnext#test # resnext_mul_serial
import pdb 
...
def generate_model( opt):
    ...
    if opt.pretrain_path:
        from models.final.resnext import get_fine_tuning_parameters
        print('loading pretrained model {}'.format(opt.pretrain_path))
        pretrain = torch.load(opt.pretrain_path)
        #print(torch.load(opt.pretrain_path)['state_dict'].keys()),exit()
