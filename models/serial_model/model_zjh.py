...
from models.serial_model import resnext_mul_serial#test # resnext_mul_serial
import pdb 
...
def generate_model( opt):
    ...
    if opt.pretrain_path:
        from models.serial_model.resnext_mul_serial import get_fine_tuning_parameters
