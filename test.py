...
import models.final.model as att
import models.final.model_org as org
#import models.improve.model as att 
...
if __name__=="__main__":
    ...
    model, parameters = att.generate_model(opt) # mars: org
    if opt.resume_path1:
    ...
    for i in checkpoint['state_dict']:
        if "sta" in i:
            print(i, checkpoint['state_dict'][i])
    exit()
    model.eval()
    ...
    result_path = "{}/".format(opt.result_path)
